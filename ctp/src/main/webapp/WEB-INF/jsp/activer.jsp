			...
			<div class="row align-items-center h-100">
				...
				<div class="col-10 card mx-auto">
					...
					<form method="POST" action="/activer">
						<% for (var questionObj : (List) request.getAttribute("questions")) { Question
							question=(Question) questionObj; %>

							<div class="form-group">
								<input class="form-check-input" type="radio" name="my_question"
									id="<%= question.getQno() %>" value="<%= question.getQno() %>">
								<label class="form-check-label" for="<%= question.getQno() %>">
									<%= question.getLibquest() %>
								</label><br>
							</div>
